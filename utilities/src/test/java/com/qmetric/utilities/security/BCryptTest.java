...
{
    String test_vectors[][] = {{"", "$2a$06$DCq7YPn5Rq63x1Lad4cll.", "$2a$06$DCq7YPn5Rq63x1Lad4cll.TV4S6ytwfsfvkgY8jIucDrjc8deX1s."},
    ...
    public void testHashpw()
    {
        ...
        for (final String[] test_vector : test_vectors)
        {
            ...
            String hashed = new BCrypt().hashpw(plain, salt);
    ...
    public void testGensaltInt()
    {
        ...
        for (int i = 4; i <= 12; i++)
        {
            ...
            for (int j = 0; j < test_vectors.length; j += 4)
            {
                ...
                String salt = new BCrypt().gensalt(i);
                String hashed1 = new BCrypt().hashpw(plain, salt);
    ...
    public void testGensalt()
    {
        ...
        for (int i = 0; i < test_vectors.length; i += 4)
        {
            ...
            String salt = new BCrypt().gensalt();
            String hashed1 = new BCrypt().hashpw(plain, salt);
            String hashed2 = new BCrypt().hashpw(plain, hashed1);
            assertEquals(hashed1, hashed2);
            System.out.print(".");
    ...
    public void testCheckpw_success()
    {
        ...
        for (final String[] test_vector : test_vectors)
        {
            String plain = test_vector[0];
            String expected = test_vector[2];
            assertTrue(new BCrypt().checkpw(plain, expected));
            System.out.print(".");
        }
    ...
    public void testCheckpw_failure()
    {
        ...
        for (int i = 0; i < test_vectors.length; i++)
        {
            ...
            assertFalse(new BCrypt().checkpw(plain, expected));
            System.out.print(".");
        }
        System.out.println("");
    }
    ...
    public void testInternationalChars()
    {
        ...
        String h1 = new BCrypt().hashpw(pw1, new BCrypt().gensalt());
        assertFalse(new BCrypt().checkpw(pw2, h1));
        System.out.print(".");

        String h2 = new BCrypt().hashpw(pw2, new BCrypt().gensalt());
        assertFalse(new BCrypt().checkpw(pw1, h2));
        System.out.print(".");
        System.out.println("");
    }
}