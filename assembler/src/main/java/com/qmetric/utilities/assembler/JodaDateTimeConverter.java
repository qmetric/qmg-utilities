...
public class JodaDateTimeConverter implements ConfigurableCustomConverter
{
    ...
    @Override public Object convert(final Object destination, final Object source, final Class destinationClass, final Class sourceClass)
    {
        ...
        throw new MappingException("Converter JodaDateTimeConverter used incorrectly. Arguments passed in were:" + destination + " and " + source);
    }
}
